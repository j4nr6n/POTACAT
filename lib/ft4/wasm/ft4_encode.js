...
async function ___ft4EncodeModule___(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('ft4_encode.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('ft4_encode.wasm', import.meta.url).href;
...
// Begin JS library code
  ...
  instrumentWasmImports(imports) {
        var importPattern = /^(_ft4_exec_encode|invoke_.*|__asyncjs__.*)$/;
...
var _ft4_exec_encode = Module['_ft4_exec_encode'] = makeInvalidEarlyAccess('_ft4_exec_encode');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['ft4_exec_encode'] != 'undefined', 'missing Wasm export: ft4_exec_encode');
  ...
  _ft4_exec_encode = Module['_ft4_exec_encode'] = createExportWrapper('ft4_exec_encode', 3);
...
export default ___ft4EncodeModule___;
