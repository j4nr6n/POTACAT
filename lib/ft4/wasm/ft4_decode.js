...
async function ___ft4DecodeModule___(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('ft4_decode.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('ft4_decode.wasm', import.meta.url).href;
...
// Begin JS library code
  ...
  instrumentWasmImports(imports) {
        var importPattern = /^(_ft4_exec_decode|invoke_.*|__asyncjs__.*)$/;
...
var _ft4_init_decode = Module['_ft4_init_decode'] = makeInvalidEarlyAccess('_ft4_init_decode');
var _ft4_exec_decode = Module['_ft4_exec_decode'] = makeInvalidEarlyAccess('_ft4_exec_decode');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['ft4_init_decode'] != 'undefined', 'missing Wasm export: ft4_init_decode');
  assert(typeof wasmExports['ft4_exec_decode'] != 'undefined', 'missing Wasm export: ft4_exec_decode');
  ...
  _ft4_init_decode = Module['_ft4_init_decode'] = createExportWrapper('ft4_init_decode', 0);
  _ft4_exec_decode = Module['_ft4_exec_decode'] = createExportWrapper('ft4_exec_decode', 3);
...
export default ___ft4DecodeModule___;
